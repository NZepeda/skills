...
- `feature-owner`: Orchestrate a feature end-to-end with minimal user input, but require explicit approval before kickoff, technical planning, and implementation.
